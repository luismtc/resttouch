...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrdenGkService", function() { return OrdenGkService; });
...
class OrdenGkService {
    ...
    seguimiento(fltr = {}) {
        return this.http.get(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/seguimiento?${qs__WEBPACK_IMPORTED_MODULE_3__["stringify"](fltr)}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
    anular(params) {
        return this.http.post(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/anular_orden_gk`, params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
    enviarVendors(params) {
        return this.http.post(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/envio_vendors`, params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
    cambiarEstatus(params) {
        return this.http.post(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/cambiar_estatus`, params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
    cambiarEstatusSede(idOrdenGk) {
        return this.http.get(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/actualiza_estatus_sede/${idOrdenGk}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
    regeneraOrdenRT(idOrdenGk) {
        return this.http.get(`${_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].urlGhostKitchen}/${this.moduleUrl}/regenera_orden_rt/${idOrdenGk}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_0__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.srvcErrHndl.errorHandler));
    }
}
OrdenGkService.ɵfac = function OrdenGkService_Factory(t) { return new (t || OrdenGkService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"])); };
OrdenGkService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({ token: OrdenGkService, factory: OrdenGkService.ɵfac, providedIn: 'root' });


/***/ })

}]);
//# sourceMappingURL=default~ghost-kitchen-ghost-kitchen-module~restaurante-restaurante-module-es2015.js.map