...
const SHOW_ANIMATION = `${_angular_material_core__WEBPACK_IMPORTED_MODULE_4__["AnimationDurations"].ENTERING} ${_angular_material_core__WEBPACK_IMPORTED_MODULE_4__["AnimationCurves"].DECELERATION_CURVE}`;
const HIDE_ANIMATION = `${_angular_material_core__WEBPACK_IMPORTED_MODULE_4__["AnimationDurations"].EXITING} ${_angular_material_core__WEBPACK_IMPORTED_MODULE_4__["AnimationCurves"].ACCELERATION_CURVE}`;
/**
 * Internal component that wraps user-provided keyboard content.
 * \@docs-private
 */
class MatKeyboardContainerComponent extends _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_2__["BasePortalOutlet"] {
    /**
     * @param {?} _ngZone
    ...
    constructor(_ngZone, _changeDetectorRef) {
         ...
         */
        this.onExit = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_0__["Subject"]();
        /**
         * Subject for notifying that the keyboard has finished entering the view.
         */
        this.onEnter = new rxjs_Subject__WEBPACK_IMPORTED_MODULE_0__["Subject"]();
        this.attrRole = 'alert';
    }
    /**
     * @param {?} event
 ...
 * @suppress {checkTypes} checked by tsc
 */
const MAT_KEYBOARD_LAYOUTS = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('keyboard-layouts.config');
...
class MatKeyboardService {
    ...
    _attachKeyboardContainer(overlayRef, config) {
        const /** @type {?} */ containerPortal = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_2__["ComponentPortal"](MatKeyboardContainerComponent, config.viewContainerRef);
    ...
    _attachKeyboardContent(config) {
        ...
        const /** @type {?} */ portal = new _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_2__["ComponentPortal"](MatKeyboardComponent);
     ...
     */
    _createOverlay() {
        const /** @type {?} */ state$$1 = new _angular_cdk_overlay__WEBPACK_IMPORTED_MODULE_7__["OverlayConfig"]({
            width: '100%'
        });
 ...
 * @suppress {checkTypes} checked by tsc
 */
const MAT_KEYBOARD_DEADKEYS = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('keyboard-deadkey.config');
 ...
 * @suppress {checkTypes} checked by tsc
 */
const MAT_KEYBOARD_ICONS = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('keyboard-icons.config');
const keyboardIcons = {
...
let ArticuloService = class ArticuloService {
    constructor(http, ls) {
        ...
        this.usrToken = null;
        this.transformArticuloToNodo = (grps) => {
            let np = [];
    ...
    adaptCategoriaGrupoResponse(lista) {
        let lst = [];
    ...
    convertToArbolNodoProducto(articulos) {
        let arbol = [];
    ...
    getArticuloDetalle(idarticulo, fltr = {}) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': this.usrToken
            })
...
ArticuloService.ctorParameters = () => [
