...
let CobrarPedidoComponent = class CobrarPedidoComponent {
    constructor(dialogRef, data, _snackBar, formaPagoSrvc, cobroSrvc, facturaSrvc, ls) {
...
let FormFacturaManualComponent = class FormFacturaManualComponent {
    ...
    socket, ls) {
        ...
        this.refacturar = () => {
            this.factura = {
                factura: this.factura.factura, factura_serie: null, cliente: null, fecha_factura: moment__WEBPACK_IMPORTED_MODULE_5__().format(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].dbDateFormat), moneda: null, exenta: 0, notas: null,
