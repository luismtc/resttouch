(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pos-pos-module~restaurante-restaurante-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CobrarPedidoComponent = /** @class */ (function () {
                function CobrarPedidoComponent(dialog, dialogRef, data, snackBar, formaPagoSrvc, cobroSrvc, facturaSrvc, ls, socket) {
                    var _this = this;
                    this.dialog = dialog;
                    ...
                    this.addFormaPago = function () {
                        var fp = _this.lstFormasPago.filter(function (f) { return +f.forma_pago === +_this.formaPago.forma_pago; })[0];
                        if (+fp.pedirautorizacion === 1) {
                            var vpgtRef = _this.dialog.open(_shared_components_check_password_check_password_component__WEBPACK_IMPORTED_MODULE_8__["CheckPasswordComponent"], {
                                width: '40%',
                                disableClose: true,
                            ...
                            vpgtRef.afterClosed().subscribe(function (res) {
                                if (res) {
                                    _this.agregaFormaPago(fp);
                                }
                                else {
                                    _this.snackBar.open('La contraseña no es correcta', 'Formas de pago', { duration: 5000 });
                                }
                            });
                        }
                        else {
                    ...
                    this.agregaFormaPago = function (fp) {
                        _this.formasPagoDeCuenta.push({
                            ...
                            documento: (_this.formaPago.documento || null)
                        });
                        _this.actualizaSaldo();
                        _this.pideDocumento = false;
                    };
                        ...
                        _this.cobroSrvc.save(objCobro).subscribe(function (res) {
                            if (res.exito && !res.facturada) {
                                ...
                                _this.facturaSrvc.facturar(_this.factReq).subscribe(function (resFact) {
                                    ...
                                    if (resFact.exito) {
                                        var confirmRef = _this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmDialogComponent"], {
                                            maxWidth: '400px',
                                        ...
                                        confirmRef.afterClosed().subscribe(function (confirma) {
                                            if (confirma) {
                                                _this.printFactura(resFact.factura);
                                            }
                                            _this.resetFactReq();
                                        ...
                                        _this.facturando = false;
                                        _this.snackBar.open('Factura', "ERROR: " + res.mensaje, { duration: 7000 });
                                        _this.dialogRef.close(res.cuenta);
                                    }
                                });
                            }
                    ...
                    this.onSelectionChangeFP = function (msc) {
                        var idx = _this.lstFormasPago.findIndex(function (lfp) { return +lfp.forma_pago === +msc.value; });
                        if (idx > -1) {
                            _this.pideDocumento = +_this.lstFormasPago[idx].pedirdocumento === 1;
                        }
                    };
                }
            ...
            var FormFacturaManualComponent = /** @class */ (function () {
                ...
                socket, ls) {
                    ...
                    this.refacturar = function () {
                        _this.factura = {
                            factura: _this.factura.factura, factura_serie: null, cliente: null,
                    ...
                    this.representacionGrafica = function () {
                        window.open("" + _shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].infilePdfUrl + _this.factura.fel_uuid, 'winFactPdf', 'height=700,width=800,menubar=no,location=no,resizable=no,scrollbars=no,status=no');
                    };
                }
