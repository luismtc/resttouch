(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pos-pos-module~restaurante-restaurante-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MonedaService = /** @class */ (function () {
                function MonedaService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                MonedaService.prototype.get = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CobrarPedidoComponent = /** @class */ (function () {
                function CobrarPedidoComponent(dialogRef, data, _snackBar, formaPagoSrvc, cobroSrvc, facturaSrvc, ls) {
                    var _this = this;
                    ...
                    this.resetFactReq = function () {
                        _this.factReq = { cuentas: [], factura_serie: 1, cliente: null, fecha_factura: moment__WEBPACK_IMPORTED_MODULE_6__().format(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].dbDateFormat), moneda: 1 };
                    };
                    this.processData = function () {
                        if (_this.data) {
                            _this.inputData = _this.data;
                        }
                        else {
                            _this.data = _this.inputData;
                        }
                        _this.inputData.totalDeCuenta = 0.00;
                        _this.inputData.productosACobrar.forEach(function (item) {
                            _this.inputData.totalDeCuenta += (item.precio * item.cantidad);
                        });
                    ...
                    this.loadFormasPago = function () {
                        _this.formaPagoSrvc.get({ activo: 1 }).subscribe(function (res) {
                            if (!!res && res.length > 0) {
                                _this.lstFormasPago = res;
                            }
                        });
                    };
                    ...
                    this.delFormaPago = function (idx) {
                        _this.formasPagoDeCuenta.splice(idx, 1);
                        _this.actualizaSaldo();
                    };
                    ...
                    this.setClienteFacturar = function (obj) {
                        _this.clienteSelected = obj;
                        _this.factReq.cliente = +obj.cliente;
                    };
                    this.cobrar = function () {
                        var objCobro = {
                            cuenta: _this.inputData.idcuenta,
                            forma_pago: [],
                            total: _this.inputData.totalDeCuenta + _this.inputData.montoPropina,
                            propina_monto: _this.inputData.montoPropina,
                            propina_porcentaje: _this.inputData.porcentajePropina
                        };
                        for (var _i = 0, _a = _this.formasPagoDeCuenta; _i < _a.length; _i++) {
                            var fp = _a[_i];
                        ...
                        _this.cobroSrvc.save(objCobro).subscribe(function (res) {
                            if (res.exito || !res.facturada) {
                                _this._snackBar.open('Cobro', "" + res.mensaje, { duration: 3000 });
                                _this.facturaSrvc.facturar(_this.factReq).subscribe(function (resFact) {
                                    if (resFact.exito) {
                                        _this.resetFactReq();
                                        _this._snackBar.open('Factura', "" + resFact.mensaje, { duration: 3000 });
                                ...
                                _this._snackBar.open('Cobro', "ERROR: " + res.mensaje, { duration: 3000 });
                            }
                        });
                    };
                }
                ...
                CobrarPedidoComponent.prototype.calculaPorcentajePropina = function () {
            ...
            CobrarPedidoComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FacturaManualComponent = /** @class */ (function () {
                function FacturaManualComponent() {
                    ...
                    this.setFactura = function (fact) {
                        ...
                        _this.frmFactura.loadDetalleFactura(+_this.factura.factura);
                        _this.frmFactura.resetDetalleFactura();
                    };
                    this.refreshFacturaList = function () { return _this.lstFacturaComponent.loadFacturas(); };
                    this.factura = {
                ...
                FacturaManualComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormFacturaManualComponent = /** @class */ (function () {
                function FormFacturaManualComponent(_snackBar, dialog, facturaSrvc, facturaSerieSrvc, clienteSrvc, monedaSrvc, articuloSrvc, 
                ...
                socket, ls) {
                    ...
                    this.loadFacturaSeries = function () {
                        _this.facturaSerieSrvc.get().subscribe(function (res) {
                            if (res) {
                                _this.facturaSeries = res;
                            }
                        });
                    };
                    this.loadClientes = function () {
                        _this.clienteSrvc.get().subscribe(function (res) {
                            if (res) {
                                _this.clientes = res;
                            }
                        });
                    ...
                    this.loadMonedas = function () {
                        _this.monedaSrvc.get().subscribe(function (res) {
                            if (res) {
                                _this.monedas = res;
                            }
                        });
                    ...
                    this.refacturar = function () {
                        _this.factura = {
                            factura: _this.factura.factura, factura_serie: null, cliente: null, fecha_factura: moment__WEBPACK_IMPORTED_MODULE_5__().format(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].dbDateFormat), moneda: null, exenta: 0, notas: null,
                            fel_uuid: null, fel_uuid_anulacion: null
                        };
                        _this.refacturacion = true;
                    };
                    this.resetFactura = function () {
                        _this.factura = {
                            factura: null, factura_serie: null, cliente: null, fecha_factura: moment__WEBPACK_IMPORTED_MODULE_5__().format(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].dbDateFormat), moneda: null, exenta: 0, notas: null,
                            fel_uuid: null, fel_uuid_anulacion: null
                        };
                        _this.resetDetalleFactura();
                        _this.detallesFactura = [];
                    };
                    this.onSubmit = function () {
                        if (_this.refacturacion) {
                            _this.facturaSrvc.refacturar(_this.factura).subscribe(function (res) {
                                if (res.exito) {
                                    _this.facturaSavedEv.emit();
                                    _this.resetFactura();
                                    _this.refacturacion = false;
                                    _this.factura = {
                                    ...
                                    _this._snackBar.open('Factura manual agregada...', 'Factura', { duration: 3000 });
                                }
                            });
                        }
                        else {
                            _this.facturaSrvc.save(_this.factura).subscribe(function (res) {
                                if (res.exito) {
                                    _this.facturaSavedEv.emit();
                                    _this.resetFactura();
                                    _this.factura = {
                    ...
                    this.firmarFactura = function () {
                        ...
                        dialogRef.afterClosed().subscribe(function (res) {
                            if (res) {
                                _this.facturaSrvc.firmar(+_this.factura.factura).subscribe(function (resFirma) {
                                    if (resFirma.exito) {
                                        _this.factura.numero_factura = resFirma.factura.numero_factura;
                                        _this.factura.serie_factura = resFirma.factura.serie_factura;
                                        _this.factura.certificador_fel = resFirma.factura.certificador_fel;
                                        _this.factura.fel_uuid = resFirma.factura.fel_uuid;
                                        _this.facturaSavedEv.emit();
                                        _this._snackBar.open('Factura firmada con éxito...', 'Firmar', { duration: 3000 });
                                    }
                                    else {
                                        _this._snackBar.open("ERROR: " + resFirma.mensaje, 'Firmar', { duration: 3000 });
                                    }
                                });
                            }
                        });
                    ...
                    this.procesaDetalleFactura = function (detalle) {
                        var detFact = [];
                        detalle.forEach(function (d) { return detFact.push({
                            Cantidad: +d.cantidad,
                    ...
                    this.getTotalDetalle = function (detalle) {
                        var suma = 0.00;
                        detalle.forEach(function (d) { return suma += +d.total; });
                        return suma;
                    };
                    this.imprimirFactura = function () {
                        ...
                        _this.facturaSrvc.imprimir(+_this.factura.factura).subscribe(function (res) {
                            if (res.factura) {
                                ...
                                _this._snackBar.open("ERROR: " + res.mensaje, 'Impresión', { duration: 3000 });
                            }
                        });
                    };
                    this.anularFactura = function () {
                        ...
                        dialogRef.afterClosed().subscribe(function (res) {
                            if (res) {
                                _this.facturaSrvc.anular(+_this.factura.factura).subscribe(function (resAnula) {
                                    if (resAnula.exito) {
                                        _this.factura.fel_uuid_anulacion = resAnula.factura.fel_uuid_anulacion;
                                        _this.facturaSavedEv.emit();
                                        _this._snackBar.open('Factura anulada con éxito...', 'Firmar', { duration: 3000 });
                                    }
                                    else {
                                        _this._snackBar.open("ERROR: " + resAnula.mensaje, 'Firmar', { duration: 10000 });
                                    }
                                });
                            }
                        });
                    ...
                    this.setPrecioUnitario = function (obj) {
                        var idxArticulo = _this.articulos.findIndex(function (a) { return +a.articulo === +obj.value; });
                        if (idxArticulo > -1) {
                            _this.detalleFactura.precio_unitario = +_this.articulos[idxArticulo].precio;
                            _this.detalleFactura.total = +_this.detalleFactura.precio_unitario * +_this.detalleFactura.cantidad;
                        }
                    };
                    this.resetDetalleFactura = function () { return _this.detalleFactura = {
                        detalle_factura: null, factura: (_this.factura.factura || 0), articulo: null, cantidad: 1, precio_unitario: null, total: null
                    }; };
                    this.loadDetalleFactura = function (idfactura) {
                        if (idfactura === void 0) { idfactura = +_this.factura.factura; }
                        _this.facturaSrvc.getDetalle(idfactura, { factura: idfactura }).subscribe(function (res) {
                            // console.log(res);
                            if (res) {
                                _this.detallesFactura = res;
                                _this.updateTableDataSource();
                            }
                        });
                    };
                    this.getDetalleFactura = function (idfactura, iddetalle) {
                        if (idfactura === void 0) { idfactura = +_this.factura.factura; }
                        _this.facturaSrvc.getDetalle(idfactura, { detalle_factura: iddetalle }).subscribe(function (res) {
                            // console.log(res);
                            if (res) {
                                _this.detalleFactura = {
                    ...
                    this.onSubmitDetail = function () {
                        ...
                        _this.facturaSrvc.saveDetalle(_this.detalleFactura).subscribe(function (res) {
                            // console.log(res);
                            if (res) {
                                _this.loadDetalleFactura();
                                _this.resetDetalleFactura();
                            }
                        });
                    };
                    this.updateTableDataSource = function () { return _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.detallesFactura); };
                }
                FormFacturaManualComponent.prototype.ngOnInit = function () {
                    this.esMovil = this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].usrTokenVar).enmovil || false;
                    this.refacturacion = false;
                    this.resetFactura();
            ...
            FormFacturaManualComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormFormaPagoComponent = /** @class */ (function () {
                function FormFormaPagoComponent(_snackBar, formaPagoSrvc, ls) {
                    var _this = this;
                    this._snackBar = _snackBar;
                    this.formaPagoSrvc = formaPagoSrvc;
                    this.ls = ls;
                    ...
                    this.esMovil = false;
                    this.resetFormaPago = function () { return _this.formaPago = { forma_pago: null, descripcion: null, activo: 1 }; };
                    this.onSubmit = function () {
                        _this.formaPagoSrvc.save(_this.formaPago).subscribe(function (res) {
                            //console.log(res);
                            if (res.exito) {
                                _this.formaPagoSavedEv.emit();
                ...
                FormFormaPagoComponent.prototype.ngOnInit = function () {
                    this.esMovil = this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].usrTokenVar).enmovil || false;
                };
                return FormFormaPagoComponent;
            }());
            FormFormaPagoComponent.ctorParameters = function () { return [
                { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var FormaPagoComponent = /** @class */ (function () {
                function FormaPagoComponent() {
                    var _this = this;
                    this.setFormaPago = function (fp) { return _this.formaPago = fp; };
                    this.refreshFormaPagoList = function () { return _this.lstFormaPagoComponent.loadFormasPago(); };
                    this.formaPago = { forma_pago: null, descripcion: null, activo: 1 };
                }
                FormaPagoComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../admin/services/localstorage.service */ "./src/app/admin/services/localstorage.service.ts");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var CobroService = /** @class */ (function () {
                function CobroService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                CobroService.prototype.save = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
            ...
            CobroService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js");
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/ __webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_7__);
            var FacturaSerieService = /** @class */ (function () {
                function FacturaSerieService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                    //private moduleUrl: string = 'turno';
                    this.usrToken = null;
                ...
                FacturaSerieService.prototype.get = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
            ...
            FacturaSerieService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FacturaService = /** @class */ (function () {
                function FacturaService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                FacturaService.prototype.facturar = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.get = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                FacturaService.prototype.imprimir = function (idfactura) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.save = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.refacturar = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.firmar = function (identidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.anular = function (identidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                FacturaService.prototype.getDetalle = function (idfactura, fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                FacturaService.prototype.saveDetalle = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
            ...
            FacturaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormaPagoService = /** @class */ (function () {
                function FormaPagoService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                FormaPagoService.prototype.get = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                FormaPagoService.prototype.buscar = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                FormaPagoService.prototype.save = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
            ...
            FormaPagoService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
