            ...
            var CobrarPedidoComponent = /** @class */ (function () {
                function CobrarPedidoComponent(dialogRef, data, _snackBar, formaPagoSrvc, cobroSrvc, facturaSrvc, ls) {
                    ...
                    this.cobrar = function () {
                        ...
                        for (var i = 0; i < _this.formasPagoDeCuenta.length; i++) {
                            objCobro.forma_pago.push({
                                forma_pago: +_this.formasPagoDeCuenta[i].forma_pago.forma_pago,
                                monto: _this.formasPagoDeCuenta[i].monto
                            });
                        }
