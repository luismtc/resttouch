...
let FormEgresoComponent = class FormEgresoComponent {
    constructor(_snackBar, ls, egresoSrvc, tipoMovimientoSrvc, bodegaSrvc, articuloSrvc, proveedorSrvc, transformacionSrvc, presentacionSrvc) {
        ...
        this.resetDetalleMerma = () => this.detalleMerma = {
            egreso_detalle: null, egreso: (!!this.egreso.egreso ? this.egreso.egreso : null), articulo: null, cantidad: null, precio_unitario: null, precio_total: null, presentacion: 0
        };
        ...
        this.updateTableDataSourceM = () => this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.detallesMerma);
    }
    ngOnInit() {
...
let ListaEgresoComponent = class ListaEgresoComponent {
    ...
    applyFilter() {
        if (this.txtFiltro.length > 0) {
            const tmpList = Object(_shared_global__WEBPACK_IMPORTED_MODULE_2__["MultiFiltro"])(this.lstEgresos, this.txtFiltro);
...
let ListaIngresoComponent = class ListaIngresoComponent {
    ...
    applyFilter() {
        if (this.txtFiltro.length > 0) {
            const tmpList = Object(_shared_global__WEBPACK_IMPORTED_MODULE_2__["MultiFiltro"])(this.lstIngresos, this.txtFiltro);
            this.length = tmpList.length;
...
let FormProductoComponent = class FormProductoComponent {
    constructor(dialog, snackBar, ls, articuloSrvc, medidaSrvc, presentacionSrvc) {
        this.dialog = dialog;
        ...
        this.eliminaReceta = (item) => {
            ...
            const confirmRef = this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_10__["ConfirmDialogComponent"], {
                maxWidth: '400px',
