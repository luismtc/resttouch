...
let FormImpresoraComponent = class FormImpresoraComponent {
    constructor(snackBar, impresoraSrvc) {
        this.snackBar = snackBar;
...
let TableroComponent = class TableroComponent {
    constructor(snackBar, tableroService) {
        ...
        this.loadDataGraficas = () => {
            this.cargando = true;
            if (!this.params.fdel) {
                this.params.fdel = moment__WEBPACK_IMPORTED_MODULE_6__().subtract(1, 'week').format(_shared_global__WEBPACK_IMPORTED_MODULE_7__["GLOBAL"].dbDateFormat);
            }
            if (!this.params.fal) {
                this.params.fal = moment__WEBPACK_IMPORTED_MODULE_6__().format(_shared_global__WEBPACK_IMPORTED_MODULE_7__["GLOBAL"].dbDateFormat);
            }
            this.tableroService.getDataGraficas(this.params).subscribe((res) => {
                this.cargando = false;
                console.log(res);
                if (res.exito) {
...
let TableroService = class TableroService {
    constructor(http, ls) {
        ...
        this.getDataGraficas = (params) => {
            const httpOptions = {
                headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                    'Authorization': this.usrToken
                })
            };
            return this.http.get(`${_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].url}/tablero/get_datos_graficas_ventas?${qs__WEBPACK_IMPORTED_MODULE_7__["stringify"](params)}`, httpOptions)
...
let ComandaService = class ComandaService {
    ...
    setComandaCocinada(idcomanda, estatus = 2) {
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                'Authorization': this.usrToken
            })
...
class ConfigCheckPasswordModel {
    constructor(tipo, subtitulo, etiquetaAceptar) {
        this.tipo = tipo;
        this.subtitulo = subtitulo;
        this.etiquetaAceptar = etiquetaAceptar;
    }
}
let CheckPasswordComponent = class CheckPasswordComponent {
    constructor(comandaSrvc, dialogRef, data) {
...
CheckPasswordComponent.ctorParameters = () => [
