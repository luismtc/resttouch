...
let AbrirMesaComponent = class AbrirMesaComponent {
    constructor(dialogRef, data, dialogDatosCuentas, usuarioSrvc, ls) {
        ...
        this.esMovil = false;
        this.loadMeseros = () => {
            this.usuarioSrvc.get({ debaja: 0, sede: (this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_6__["GLOBAL"].usrTokenVar).sede || 0), esmesero: 1 }).subscribe(res => {
                if (res) {
                    this.lstMeseros = res;
                }
            });
...
let ListaProductosComandaComponent = class ListaProductosComandaComponent {
    constructor(_snackBar, ls, comandaSrvc) {
        this._snackBar = _snackBar;
        this.ls = ls;
