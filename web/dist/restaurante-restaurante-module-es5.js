(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["restaurante-restaurante-module"], {
            ...
            var AbrirMesaComponent = /** @class */ (function () {
                function AbrirMesaComponent(dialogRef, data, dialogDatosCuentas, usuarioSrvc, ls) {
                    ...
                    this.loadMeseros = function () {
                        _this.usuarioSrvc.getMeserosTurno().subscribe(function (res) {
                            if (res) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AreaDesignerComponent = /** @class */ (function () {
                ...
                function AreaDesignerComponent(snackBar, mesaSrvc, dialogRef, dialog, 
                ...
                data) {
                    ...
                    this.getNextTableNumber = function () { return _this.mesas.length > 0 ?
                        ...
                        1; };
                    this.addTable = function (w, h, esmostrador, vertical) {
                        if (w === void 0) { w = null; }
                        if (h === void 0) { h = null; }
                        if (esmostrador === void 0) { esmostrador = 0; }
                    ...
                    this.addMostrador = function (esVertical) {
                        if (esVertical === void 0) { esVertical = false; }
                        return _this.addTable((esVertical ? 72 : 144), (esVertical ? 144 : 72), 1, (esVertical ? 1 : 0));
                    };
                    this.saveNewMesa = function (mesa, pos) {
                        _this.mesaSrvc.save(mesa).subscribe(function (res) {
                            if (res.exito) {
                                ...
                                _this.snackBar.open("ERROR: " + res.mensaje, 'Mesa', { duration: 7000 });
                            }
                        });
                    };
                    this.onClickMesa = function (obj) { };
                    this.terminar = function () { return _this.dialogRef.close(_this.mesas); };
                    this.configurarMesa = function (item) {
                        var configMesaRef = _this.dialog.open(_configura_mesa_configura_mesa_component__WEBPACK_IMPORTED_MODULE_5__["ConfiguraMesaComponent"], {
                            width: '50%',
                            data: { mesa: item }
                        });
                        configMesaRef.afterClosed().subscribe(function (res) {
                        });
                    };
                    this.toggleDeBaja = function (item, deBaja) {
                        if (deBaja === void 0) { deBaja = 1; }
                        var confBajaMesa = _this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_6__["ConfirmDialogComponent"], {
                            maxWidth: '400px',
                        ...
                        confBajaMesa.afterClosed().subscribe(function (conf) {
                            if (conf) {
                                item.debaja = deBaja;
                                _this.mesaSrvc.save(item).subscribe(function (res) {
                                    if (res.exito) {
                                        if (!!res.mesa) {
                                            var idx = _this.mesas.findIndex(function (m) { return +m.mesa === +res.mesa.mesa; });
                                            if (idx > -1) {
                                                _this.mesas[idx] = res.mesa;
                                            }
                                            _this.snackBar.open(res.mensaje, 'Mesa', { duration: 3000 });
                                        }
                                    }
                                    else {
                                        _this.snackBar.open("ERROR: " + res.mensaje, 'Mesa', { duration: 7000 });
                ...
                AreaDesignerComponent.prototype.onContextMenu = function (event, item) {
                    event.preventDefault();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfiguraMesaComponent = /** @class */ (function () {
                function ConfiguraMesaComponent(mesaSrvc, impresoraSrvc, snackBar, dialogRef, data) {
                    var _this = this;
                    this.mesaSrvc = mesaSrvc;
                    ...
                    this.guardarConfiguracion = function () {
                        _this.mesaSrvc.save(_this.mesa).subscribe(function (res) {
                            if (res.exito) {
                                if (!!res.mesa) {
                                    _this.snackBar.open("Mesa #" + res.mesa.numero + " actualizada...", 'Configuración de mesa', { duration: 3000 });
                                }
                                else {
                                    _this.snackBar.open("Mesa #" + _this.mesa.numero + " actualizada...", 'Configuración de mesa', { duration: 3000 });
                                }
                            }
                            else {
                                _this.snackBar.open("ERROR:" + res.mensaje + ".", 'Configuración de mesa', { duration: 7000 });
                            }
                            _this.dialogRef.close(true);
                        });
                    };
                }
                ConfiguraMesaComponent.prototype.ngOnInit = function () {
                    this.mesa = this.data.mesa;
                    this.loadImpresoras();
                };
                return ConfiguraMesaComponent;
            }());
            ConfiguraMesaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormAreaComponent = /** @class */ (function () {
                function FormAreaComponent(snackBar, dialog, entidadSrvc, impresoraSrvc, ls) {
                    var _this = this;
                    this.snackBar = snackBar;
                    this.dialog = dialog;
                    ...
                    this.esMovil = false;
                    this.impresoras = [];
                    this.loadAreas = function () { return _this.entidadSrvc.get({ sede: _this.sedeUsr, debaja: 1 }).subscribe(function (res) { return _this.lstAreas = res; }); };
                    this.loadImpresoras = function () { return _this.impresoraSrvc.get().subscribe(function (res) { return _this.impresoras = res; }); };
                    ...
                    this.onSubmit = function () {
                        ...
                        _this.entidadSrvc.save(_this.entidad).subscribe(function (res) {
                            if (res.exito) {
                                _this.snackBar.open("" + res.mensaje, 'Área', { duration: 3000 });
                                _this.resetEntidad();
                                _this.loadAreas();
                                _this.entidadSavedEv.emit();
                            }
                            else {
                                _this.snackBar.open("ERROR: " + res.mensaje, 'Área', { duration: 3000 });
                            }
                        });
                    };
                    this.openDesigner = function () {
                        ...
                        areaDesignerRef.afterClosed().subscribe(function (result) {
                            if (result) {
                                // console.log(result);
                                _this.entidadSavedEv.emit();
                                _this.entidadSrvc.get({ area: +_this.entidad.area, debaja: 1 }).subscribe(function (res) {
                                    if (res && res.length > 0) {
                                        _this.entidad = res[0];
                                    }
                                });
            ...
            var ListaAreaComponent = /** @class */ (function () {
                function ListaAreaComponent(areaSrvc, ls) {
                    ...
                    this.loadEntidades = function () {
                        _this.areaSrvc.get({ sede: (_this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].usrTokenVar).sede || 0), debaja: 1 }).subscribe(function (lst) {
                            if (lst) {
                                if (lst.length > 0) {
                    ...
                    this.getEntidad = function (id) {
                        _this.areaSrvc.get({ area: id, debaja: 1 }).subscribe(function (lst) {
                            if (lst) {
                                if (lst.length > 0) {
                ...
                ListaAreaComponent.prototype.applyFilter = function () {
                    if (this.txtFiltro.length > 0) {
                        var tmpList = Object(_shared_global__WEBPACK_IMPORTED_MODULE_3__["MultiFiltro"])(this.lstEntidades, this.txtFiltro);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CajacorteFormComponent = /** @class */ (function () {
                function CajacorteFormComponent(_snackBar, cajacorteSrvc) {
                    var _this = this;
                    ...
                    this.getCajaCorteTipo = function () {
                        _this.cajacorteSrvc.getCajaCorteTipo().subscribe(function (res) {
                            _this.ccorteTipo = res;
                        });
                    };
                    this.getCajaCorteNominacion = function () {
                        _this.cajacorteSrvc.getCajaCorteNominacion().subscribe(function (res) {
                            _this.ccorteNomi = res;
                        });
                    };
                    this.setTotal = function () {
                        if (_this.detalle.caja_corte_nominacion) {
                            var tmp = _this.ccorteNomi.filter(function (o) {
                                return o.caja_corte_nominacion == _this.detalle.caja_corte_nominacion;
                            })[0];
                            if (tmp.calcula == 1) {
                                _this.detalle.total = _this.detalle.cantidad * tmp.valor;
                            }
                            else {
                                _this.detalle.total = _this.detalle.cantidad;
                            }
                        }
                    };
                    this.setNamenomi = function () {
                        var tmp = _this.ccorteNomi.filter(function (o) {
                            return o.caja_corte_nominacion == _this.detalle.caja_corte_nominacion;
                        })[0];
                        console.log(tmp, _this.detalle.caja_corte_nominacion);
                        _this.detalle.nombre = tmp.nombre;
                    };
                    this.setNameTipo = function () {
                        var tmp = _this.ccorteTipo.filter(function (o) {
                            return o.caja_corte_tipo == _this.ccorte.caja_corte_tipo;
                        })[0];
                        console.log(tmp, _this.ccorte.caja_corte_tipo);
                        _this.ccorte.descripcion = tmp.descripcion;
                    };
                    this.reseteGeneral = function () { return _this.ccorte = {
                        caja_corte: 0,
                        creacion: null,
                        usuario: 0,
                        turno: 0,
                    ...
                    this.resetDetalle = function () { return _this.detalle = {
                        caja_corte_detalle: 0,
                        caja_corte: 0,
                        cantidad: 0,
                        total: 0,
                    ...
                    this.agregarDetalle = function () {
                        if (_this.detalle.caja_corte_nominacion &&
                            _this.detalle.cantidad &&
                            _this.detalle.total) {
                            _this.ccorte.detalle.push(_this.detalle);
                            _this.resetDetalle();
                        }
                        else {
                            _this._snackBar.open("Complete los datos de nominaciones", 'Corte de caja', { duration: 3000 });
                        }
                    };
                    this.guardar = function () {
                        if (confirm('¿Está seguro?')) {
                            if (_this.ccorte.detalle.length == 0) {
                                _this._snackBar.open("Por favor agregue las nominaciones", 'Corte de caja', { duration: 3000 });
                                return false;
                            }
                            if (!_this.ccorte.caja_corte_tipo) {
                                _this._snackBar.open("Seleccione el tipo de corte de caja.", 'Corte de caja', { duration: 3000 });
                                return false;
                            }
                            _this.cajacorteSrvc.guardar(_this.ccorte).subscribe(function (res) {
                                if (res.exito) {
                                    _this.cajacorteSavedEv.emit();
                                    _this.reseteGeneral();
                                }
                                _this._snackBar.open("" + res.mensaje, 'Corte de caja', { duration: 3000 });
                            });
                        }
                    };
                    this.anularCajaDetalle = function (obj) {
                        if (confirm('¿Está seguro.?')) {
                            if (obj.caja_corte_detalle) {
                                _this.cajacorteSrvc.anularDetalle(obj).subscribe(function (res) {
                                    if (res.exito) {
                                        var key = _this.ccorte.detalle.indexOf(obj);
                                        _this.ccorte.detalle.splice(key, 1);
                                    }
                                    _this._snackBar.open("" + res.mensaje, 'Corte de caja', { duration: 3000 });
                                });
                            }
                ...
                CajacorteFormComponent.prototype.ngOnInit = function () {
                    this.getCajaCorteTipo();
                    this.getCajaCorteNominacion();
                };
                return CajacorteFormComponent;
            }());
            CajacorteFormComponent.ctorParameters = function () { return [
                { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CajacorteListaComponent = /** @class */ (function () {
                function CajacorteListaComponent(ccorteSrvc, _snackBar) {
                    var _this = this;
                    ...
                    this.getCajascortes = function () {
                        _this.ccorteSrvc.buscar().subscribe(function (lst) {
                            _this.listacc = lst;
                            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.listacc);
                            _this.dataSource.paginator = _this.paginator;
                        });
                    };
                    this.anularCaja = function (obj) {
                        if (confirm('¿Si anula este corte, se anulará también las nominaciones.?')) {
                            _this.ccorteSrvc.anularCorte(obj).subscribe(function (res) {
                                if (res.exito) {
                                    _this.getCajascortes();
                                }
                                _this._snackBar.open("" + res.mensaje, 'Corte de caja', { duration: 3000 });
                            });
                        }
                    };
                    this.getCajacorte = function (obj) {
                        _this.getCajacorteEv.emit(obj);
                    };
                }
                CajacorteListaComponent.prototype.ngOnInit = function () {
                    this.getCajascortes();
                };
                CajacorteListaComponent.prototype.filtrar = function (filtro) {
                    this.dataSource.filter = filtro.trim().toLowerCase();
                };
                ;
                return CajacorteListaComponent;
            }());
            CajacorteListaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CajacorteComponent = /** @class */ (function () {
                function CajacorteComponent() {
                    var _this = this;
                    this.editarCajaCorte = function (pres) { return _this.ccorte = pres; };
                    this.actualizaLista = function () { return _this.lstCajacorteComponent.getCajascortes(); };
                    this.ccorte = {
                        caja_corte: 0,
                        creacion: null,
                        usuario: 0,
                ...
                CajacorteComponent.prototype.ngOnInit = function () {
                };
                return CajacorteComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ComandaEnLineaComponent = /** @class */ (function () {
                ...
                function ComandaEnLineaComponent(dialog, snackBar, socket, ls, comandaSrvc, facturaSrvc, dns, pdfServicio) {
                    var _this = this;
                    this.dialog = dialog;
                    this.snackBar = snackBar;
                    this.socket = socket;
                    ...
                    this.getPdf = function (obj) {
                        var noCuenta = +obj.cuentas[0].cuenta;
                    ...
                    this.printFactura = function (fact, datosOrigen) {
                        ...
                        _this.socket.emit('print:factura', JSON.stringify(dataToPrint));
                    };
                }
                ComandaEnLineaComponent.prototype.ngOnInit = function () {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListaProductosComandaComponent = /** @class */ (function () {
                ...
                function ListaProductosComandaComponent(snackBar, ls, comandaSrvc, socket, dialog) {
                    var _this = this;
                    this.snackBar = snackBar;
                    this.ls = ls;
                    this.comandaSrvc = comandaSrvc;
                    ...
                    this.esMovil = false;
                    this.removeProducto = function (p, idx, estaAutorizado) {
                        if (estaAutorizado === void 0) { estaAutorizado = false; }
                        ...
                        _this.comandaSrvc.saveDetalle(_this.IdComanda, _this.IdCuenta, _this.detalleComanda).subscribe(function (res) {
                            if (res.exito) {
                                ...
                                _this.productoRemovedEv.emit({ listaProductos: _this.listaProductos, comanda: res.comanda });
                                if (+p.cantidad === 0) {
                                    _this.socket.emit('refrescar:mesa', { mesaenuso: _this.mesaEnUso });
                                    _this.socket.emit('refrescar:listaCocina', { mesaenuso: _this.mesaEnUso });
                                }
                            }
                            else {
                    ...
                    this.deleteProductoFromList = function (p, idx, estaAutorizado) {
                        if (estaAutorizado === void 0) { estaAutorizado = false; }
                        p.cantidad = 0;
                        p.notas = '';
                        _this.removeProducto(p, idx, estaAutorizado);
                    };
                    this.deleteProductoFromListAfterPrinted = function (p, idx) {
                        ...
                        dialogoRef.afterClosed().subscribe(function (res) {
                            ...
                            if (res) {
                                // this.autorizar = true;
                                _this.deleteProductoFromList(p, idx, true);
            ...
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
            ], ListaProductosComandaComponent.prototype, "mesaEnUso", void 0);
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MesaComponent = /** @class */ (function () {
                function MesaComponent(snackBar, mesaSrvc) {
                    ...
                    this.ngAfterViewInit = function () { return _this.objMesa = _this.divMesa.nativeElement; };
                    this.clickMesa = function () { return _this.onClickMesa.emit({ mesaSelected: _this.configuracion }); };
                    this.getAncho = function () {
                        if (_this.configuracion.ancho && +_this.configuracion.ancho > 0) {
                            return _this.configuracion.ancho;
                        }
                        return _this.configuracion.tamanio;
                    };
                    this.getAlto = function () {
                        if (_this.configuracion.alto && +_this.configuracion.alto > 0) {
                            return _this.configuracion.alto;
                        }
                        return _this.configuracion.tamanio;
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormPropinaComponent = /** @class */ (function () {
                function FormPropinaComponent(_snackBar, propinaSrvc, usuarioSrvc) {
                    var _this = this;
                    this._snackBar = _snackBar;
                    ...
                    this.loadUsuario = function () {
                        _this.usuarioSrvc.get().subscribe(function (res) {
                            _this.usuarios = res;
                        });
                    };
                    this.resetPropina = function () { return _this.propina = {
                        propina_distribucion: null, usuario_tipo: null, porcentaje: null, anulado: null
                    }; };
                    this.onSubmit = function () {
                        _this.propinaSrvc.save(_this.propina).subscribe(function (res) {
                            //console.log(res);
                            if (res.exito) {
                                _this.propinaSavedEv.emit();
                                _this.resetPropina();
                                _this._snackBar.open('Propina agregada...', 'Distribucion de propinas', { duration: 3000 });
                            }
                            else {
                                _this._snackBar.open("ERROR: " + res.mensaje, 'Distribucion de propinas', { duration: 3000 });
                            }
                        });
                    };
                }
                FormPropinaComponent.prototype.ngOnInit = function () {
                    this.loadUsuario();
                };
                return FormPropinaComponent;
            }());
            FormPropinaComponent.ctorParameters = function () { return [
                { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListaPropinaComponent = /** @class */ (function () {
                function ListaPropinaComponent(propinaSrvc) {
                    var _this = this;
                    this.propinaSrvc = propinaSrvc;
                    this.displayedColumns = ['propina'];
                    this.getPropinaEv = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.loadPropinas = function () {
                        _this.propinaSrvc.get().subscribe(function (lst) {
                            if (lst) {
                                if (lst.length > 0) {
                                    _this.lstPropinas = lst;
                                    _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.lstPropinas);
                                    _this.dataSource.paginator = _this.paginator;
                                }
                            }
                        });
                    };
                    this.getPropina = function (obj) {
                        _this.getPropinaEv.emit(obj);
                    };
                }
                ListaPropinaComponent.prototype.ngOnInit = function () {
                    this.loadPropinas();
                };
                ListaPropinaComponent.prototype.applyFilter = function (filterValue) {
                    this.dataSource.filter = filterValue.trim().toLowerCase();
                };
                return ListaPropinaComponent;
            }());
            ListaPropinaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PropinaComponent = /** @class */ (function () {
                function PropinaComponent() {
                    var _this = this;
                    this.setPropina = function (pres) { return _this.propina = {
                    ...
                    this.refreshPropinaList = function () { return _this.lstPropinaComponent.loadPropinas(); };
                    this.propina = {
                        propina_distribucion: null, usuario_tipo: null, porcentaje: null, anulado: null
                    };
                }
                PropinaComponent.prototype.ngOnInit = function () {
                };
                return PropinaComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AutoconsultaComponent = /** @class */ (function () {
                ...
                AutoconsultaComponent.prototype.ngOnInit = function () {
                    this.getCampos();
                    this.getCampos({ por_fecha: 1 }, 2);
                    this.getCampos({ ordenar_por: 1 }, 3);
                };
                return AutoconsultaComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CajaComponent = /** @class */ (function () {
                function CajaComponent(snackBar, pdfServicio, tipoTurnoSrvc) {
                    var _this = this;
                    this.snackBar = snackBar;
                    this.pdfServicio = pdfServicio;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            PropinasComponent.ctorParameters = function () { return [
                { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
                { type: _services_reporte_pdf_service__WEBPACK_IMPORTED_MODULE_3__["ReportePdfService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RptVentasComponent = /** @class */ (function () {
                function RptVentasComponent(snackBar, rptVentasSrvc, tipoTurnoSrvc) {
                    var _this = this;
                    this.snackBar = snackBar;
                    ...
                    this.getPdf = function () {
                        switch (_this.params.tipo_reporte) {
                            case 1:
                                _this.getPorCategoriaPdf();
                                break;
                            case 2:
                                _this.getPorArticuloPdf();
                                break;
                        }
                    };
                    this.getPorCategoriaPdf = function () {
                        ...
                        _this.rptVentasSrvc.porCategoriaPdf(_this.paramsToSend).subscribe(function (res) {
                            ...
                            if (res) {
                                ...
                                _this.snackBar.open('No se pudo generar el reporte...', _this.tituloCategoria, { duration: 3000 });
                            }
                        });
                    };
                    this.getPorArticuloPdf = function () {
                        ...
                        _this.rptVentasSrvc.porArticuloPdf(_this.paramsToSend).subscribe(function (res) {
                            ...
                            if (res) {
                                ...
                                _this.snackBar.open('No se pudo generar el reporte...', _this.tituloArticulo, { duration: 3000 });
                            }
                        });
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".matSideNavContainer {\n    height: 90%;\n    overflow: hidden !important; \n}\n\n.divAreaMesa {\n    width: 100vw;\n    height: 90vh;\n    background-color: #c7c7c749;\n}\n\nmat-sidenav {\n    width: 97vw; \n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
            ...
            var TranAreasComponent = /** @class */ (function () {
                function TranAreasComponent(dialog, snackBar, ls, areaSrvc, comandaSrvc, socket) {
                    ...
                    this.loadAreas = function (saveOnTemp, objMesaEnUso) {
                        ...
                        _this.areaSrvc.get({ sede: (+_this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_4__["GLOBAL"].usrTokenVar).sede || 0) }).subscribe(function (res) {
                            if (!saveOnTemp) {
                                ...
                                _this.updateTableStatus(objMesaEnUso.mesaenuso);
                            }
                        });
                    };
                    this.updateTableStatus = function (objMesaEnUso) {
                        if (objMesaEnUso === void 0) { objMesaEnUso = {}; }
                    ...
                    this.cerrandoRightSideNav = function () {
                        ...
                        _this.snTrancomanda.resetListadoArticulos();
                    ...
                    this.fuerzaCierreComanda = function (shouldToggle) {
                        _this.comandaSrvc.cerrarEstacion(_this.mesaSeleccionada.comanda).subscribe(function (resCierre) {
                            _this.loadComandaMesa(_this.mesaSeleccionada.mesa, shouldToggle);
                        });
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TranCocinaComponent = /** @class */ (function () {
                function TranCocinaComponent(ls, comandaSrvc, socket, dns, snackBar, dialog) {
                    var _this = this;
                    this.ls = ls;
                    this.comandaSrvc = comandaSrvc;
                    this.socket = socket;
                    ...
                    this.loadComandasCocina = function () { return _this.comandaSrvc.getComandasCocina().subscribe(function (res) {
                        _this.lstComandasCocina = res.pendientes;
                        _this.lstComandasCocinaEnProceso = res.enproceso;
                    }); };
                    this.setCocinado = function (cmd, estatus) {
                        if (estatus === void 0) { estatus = 2; }
                        var confirmRef = _this.dialog.open(_shared_components_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_8__["ConfirmDialogComponent"], {
                            maxWidth: '400px',
                        ...
                        confirmRef.afterClosed().subscribe(function (conf) {
                            if (conf) {
                                _this.comandaSrvc.setComandaCocinada(+cmd.comanda, estatus).subscribe(function (res) {
                                    if (res.exito) {
                                        _this.snackBar.open(res.mensaje, 'Cocina', { duration: 3000 });
                                    }
                                    else {
                                        _this.snackBar.open("ERROR: " + res.mensaje, 'Cocina', { duration: 7000 });
                                    }
                                    _this.loadComandasCocina();
                                });
                            }
                        });
                    };
                }
                TranCocinaComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    if (!!this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_6__["GLOBAL"].usrTokenVar).sede_uuid) {
                        ...
                        this.socket.on('refrescar:listaCocina', function () {
                            _this.loadComandasCocina();
                            _this.notificarUsuario();
                        });
                    }
                ...
                return TranCocinaComponent;
            }());
            TranCocinaComponent.ctorParameters = function () { return [
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            "use strict";
            __webpack_require__.r(__webpack_exports__);
            /* harmony default export */ __webpack_exports__["default"] = (".divFullSize {\n    width: 100%;\n    height: 100%;\n    overflow-y: auto;\n}\n\n.col {\n    padding-top: 1px;\n    padding-bottom: 1px;\n}\n\n.btnAccionComanda {\n    width: 135px;\n}\n\n.colProductos {\n    overflow-y: auto;\n    height: 400px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TranComandaComponent = /** @class */ (function () {
                function TranComandaComponent(router, dialog, snackBar, comandaSrvc, socket, ls, pdfServicio) {
                    var _this = this;
                    this.router = router;
                    this.dialog = dialog;
                    this.snackBar = snackBar;
                    ...
                    this.resetListadoArticulos = function () { return _this.appLstProdAlt.loadArbolArticulos(); };
                    this.setListaCategorias = function (cats) {
                        if (cats === void 0) { cats = []; }
                        return _this.categorias = cats;
                    };
                    this.clickOnCategoria = function (c) { return _this.appLstProdAlt.fillSubCategorias(c.categoria_grupo); };
                    this.llenaProductosSeleccionados = function (conQueMesa) {
                        if (conQueMesa === void 0) { conQueMesa = _this.mesaEnUso; }
                        if (_this.mesaEnUso.comanda == null) {
                            _this.mesaEnUso = conQueMesa;
                        }
                ...
                TranComandaComponent.prototype.updProductosCuenta = function (obj) {
                    var _this = this;
                    var nvaLista = obj.listaProductos || [];
                            ...
                            this.comandaSrvc.save(objCmd).subscribe(function (res) {
                                ...
                                if (res.exito) {
                                    _this.comandaSrvc.setProductoImpreso(_this.cuentaActiva.cuenta).subscribe(function (resImp) {
                                        ...
                                        _this.socket.emit('refrescar:mesa', { mesaenuso: _this.mesaEnUso });
                                        _this.socket.emit('refrescar:listaCocina', { mesaenuso: _this.mesaEnUso });
                                        if (+_this.mesaEnUso.mesa.esmostrador === 0) {
                ...
                TranComandaComponent.prototype.printCuenta = function () {
                    ...
                    var totalCuenta = this.sumaDetalle(this.lstProductosAImprimir);
                    var printerToUse = this.mesaEnUso.mesa.impresora || this.mesaEnUso.mesa.area.impresora;
                    var msgToPrint = {
                        Tipo: 'Cuenta',
                            ...
                            if (productosACobrar.length > 0) {
                                var cobrarCtaRef = _this.dialog.open(_pos_components_cobrar_pedido_cobrar_pedido_component__WEBPACK_IMPORTED_MODULE_10__["CobrarPedidoComponent"], {
                                    ...
                                    data: {
                                        ...
                                        impresora: +_this.mesaEnUso.mesa.esmostrador === 0 ? null : _this.mesaEnUso.mesa.impresora || _this.mesaEnUso.mesa.area.impresora
                                    }
                                });
                                cobrarCtaRef.afterClosed().subscribe(function (resAC) {
                                    if (resAC && resAC !== 'closePanel') {
                                        // console.log(res);
                                        _this.cambiarEstatusCuenta(resAC);
                                        _this.closeSideNavEv.emit();
                                    }
                                    else {
                                        if (resAC === 'closePanel') {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormTurnoTipoComponent = /** @class */ (function () {
                function FormTurnoTipoComponent(_snackBar, turnoSrvc) {
                    var _this = this;
                    this._snackBar = _snackBar;
                    this.turnoSrvc = turnoSrvc;
                    this.turnoSavedEv = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.resetTurno = function () { return _this.turno = {
                    ...
                    this.onSubmit = function () {
                        _this.turnoSrvc.save(_this.turno).subscribe(function (res) {
                            ...
                            if (res.exito) {
                                ...
                                _this.resetTurno();
                                _this._snackBar.open('Tipo de Turno agregado...', 'Turno', { duration: 3000 });
                            }
                            else {
                ...
                FormTurnoTipoComponent.prototype.ngOnInit = function () {
                };
                return FormTurnoTipoComponent;
            }());
            FormTurnoTipoComponent.ctorParameters = function () { return [
                { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _shared_global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/global */ "./src/app/shared/global.ts");
            /* harmony import */ var _services_tipo_turno_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/tipo-turno.service */ "./src/app/restaurante/services/tipo-turno.service.ts");
            var ListaTurnoTipoComponent = /** @class */ (function () {
                function ListaTurnoTipoComponent(turnoSrvc) {
                    var _this = this;
                    this.turnoSrvc = turnoSrvc;
                    ...
                    this.loadTurnos = function () {
                        _this.turnoSrvc.get().subscribe(function (lst) {
                            if (lst) {
                                if (lst.length > 0) {
                                    _this.lstTurnos = lst;
                                    _this.applyFilter();
                ...
                ListaTurnoTipoComponent.prototype.ngOnInit = function () {
                    this.loadTurnos();
                };
                ListaTurnoTipoComponent.prototype.applyFilter = function () {
                    if (this.txtFiltro.length > 0) {
                        var tmpList = Object(_shared_global__WEBPACK_IMPORTED_MODULE_2__["MultiFiltro"])(this.lstTurnos, this.txtFiltro);
                        this.length = tmpList.length;
                ...
                return ListaTurnoTipoComponent;
            }());
            ListaTurnoTipoComponent.ctorParameters = function () { return [
                { type: _services_tipo_turno_service__WEBPACK_IMPORTED_MODULE_3__["TipoTurnoService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var TurnoTipoComponent = /** @class */ (function () {
                function TurnoTipoComponent() {
                    var _this = this;
                    this.setTurno = function (cli) { return _this.turno = cli; };
                    this.refreshTurnoList = function () { return _this.lstTurnoComponent.loadTurnos(); };
                    this.turno = {
                        turno_tipo: null, descripcion: null, activo: 1
                    };
                }
                TurnoTipoComponent.prototype.ngOnInit = function () {
                };
                return TurnoTipoComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FormTurnoComponent = /** @class */ (function () {
                function FormTurnoComponent(_snackBar, ls, tipoTurnoSrvc, turnoSrvc, usuarioTipoSrvc, usuarioSrvc, dialog) {
                    ...
                    this.getNow = function () { return moment__WEBPACK_IMPORTED_MODULE_8__().format(_shared_global__WEBPACK_IMPORTED_MODULE_5__["GLOBAL"].dbDateTimeFormat); };
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListaTurnoComponent = /** @class */ (function () {
                function ListaTurnoComponent(ls, turnoSrvc) {
                    ...
                    this.txtFiltro = '';
                    this.loadTurnos = function () {
                        _this.turnoSrvc.get({ sede: (+_this.ls.get(_shared_global__WEBPACK_IMPORTED_MODULE_2__["GLOBAL"].usrTokenVar).sede || 0) }).subscribe(function (lst) {
                            if (lst) {
                                if (lst.length > 0) {
                                    _this.lstTurnos = lst;
                                    _this.applyFilter();
                ...
                ListaTurnoComponent.prototype.applyFilter = function () {
                    if (this.txtFiltro.length > 0) {
                        var tmpList = Object(_shared_global__WEBPACK_IMPORTED_MODULE_2__["MultiFiltro"])(this.lstTurnos, this.txtFiltro);
                        this.length = tmpList.length;
                        this.lstTurnosPaged = Object(_shared_global__WEBPACK_IMPORTED_MODULE_2__["PaginarArray"])(tmpList, this.pageSize, this.pageIndex + 1);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js");
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/ __webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_7__);
            var AutoconsultaService = /** @class */ (function () {
                function AutoconsultaService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                    this.usrToken = null;
                    this.srvcErrHndl = new _shared_error_handler__WEBPACK_IMPORTED_MODULE_4__["ServiceErrorHandler"]();
                ...
                AutoconsultaService.prototype.getCampos = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                AutoconsultaService.prototype.getReporte = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken,
                    ...
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlAppRestaurante + "/reporte/autoconsulta", fltr, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                return AutoconsultaService;
            }());
            AutoconsultaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js");
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/ __webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_7__);
            var CajacorteService = /** @class */ (function () {
                function CajacorteService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                CajacorteService.prototype.buscar = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                CajacorteService.prototype.getCajaCorteTipo = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                CajacorteService.prototype.getCajaCorteNominacion = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                CajacorteService.prototype.guardar = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                ...
                CajacorteService.prototype.anularCorte = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                    };
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlAppRestaurante + "/" + this.moduleUrl + "/anular_caja", entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                CajacorteService.prototype.anularDetalle = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
                    };
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlAppRestaurante + "/" + this.moduleUrl + "/anular_caja_detalle", entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                return CajacorteService;
            }());
            CajacorteService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! qs */ "./node_modules/qs/lib/index.js");
            /* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/ __webpack_require__.n(qs__WEBPACK_IMPORTED_MODULE_7__);
            var PropinaService = /** @class */ (function () {
                function PropinaService(http, ls) {
                    this.http = http;
                    this.ls = ls;
                ...
                PropinaService.prototype.get = function (fltr) {
                    if (fltr === void 0) { fltr = {}; }
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                ...
                PropinaService.prototype.save = function (entidad) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken
                        })
            ...
            PropinaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _admin_services_localstorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalstorageService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReporteVentasService = /** @class */ (function () {
                ...
                ReporteVentasService.prototype.porCategoria = function (params) {
                    ...
                    return this.http.get(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlFacturacion + "/" + this.moduleUrl + "/categoria?" + qs__WEBPACK_IMPORTED_MODULE_7__["stringify"](params), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                ...
                ReporteVentasService.prototype.porCategoriaPdf = function (params) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken,
                ...
                ReporteVentasService.prototype.porArticuloPdf = function (params) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
                            'Authorization': this.usrToken,
                            'Accept': 'application/pdf'
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TipoTurnoService = /** @class */ (function () {
                ...
                TipoTurnoService.prototype.save = function (entidad) {
                    ...
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlMantenimientos + "/" + this.moduleUrl + "/guardar_turno_tipo" + (entidad.turno_tipo ? ('/' + entidad.turno_tipo) : ''), entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TurnoService = /** @class */ (function () {
                ...
                TurnoService.prototype.save = function (entidad) {
                    ...
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlMantenimientos + "/" + this.moduleUrl + "/guardar" + (entidad.turno ? ('/' + entidad.turno) : ''), entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                ...
                TurnoService.prototype.saveDetalle = function (entidad) {
                    ...
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlMantenimientos + "/" + this.moduleUrl + "/agregar_usuario/" + entidad.turno, entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                TurnoService.prototype.anularDetalle = function (entidad) {
                    ...
                    return this.http.post(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].urlMantenimientos + "/" + this.moduleUrl + "/anular_usuario/" + entidad.turno, entidad, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["retry"])(_shared_global__WEBPACK_IMPORTED_MODULE_3__["GLOBAL"].reintentos), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.srvcErrHndl.errorHandler));
                };
                return TurnoService;
            }());
